...
def test_q5(employee_records, ID, record_title, data, result1, result2, testcase):
    if testcase == True:
        assert update_record(employee_records, ID, record_title, data) == result1
        assert employee_records == result2
    else:
        assert hashcode(update_record(employee_records, ID, record_title, data)) == result1
