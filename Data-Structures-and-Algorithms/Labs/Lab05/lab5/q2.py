def insertion_sort(arr):
    ...
    Iteratively inserts each element into the sorted portion of the array, 
    printing the array after each insertion.

    Parameters:
    arr: Fixed-sized array of elements (numbers or strings) to be sorted.

    Returns:
    None: Sorts the array in place and prints the state after each iteration.

    Steps:
        Step 1 => If it is the first element, it is already sorted.
        Step 2 => Pick next element
        Step 3 => Compare with all elements in the sorted sub-array
        Step 4 => Shift all the elements in the sorted sub-array that is greater than the value to be sorted
