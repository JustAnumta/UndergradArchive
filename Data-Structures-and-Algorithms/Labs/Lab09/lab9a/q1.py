...
def create_graph():
    ...
    addEdges(G, [(1, 2, 1)],directed=False)
    addEdges(G, [(1, 5, 1)],directed=False)
    addEdges(G, [(2, 3, 1)],directed=False)
    addEdges(G, [(2, 4, 1)],directed=False)
    addEdges(G, [(2, 5, 1)],directed=False)
    addEdges(G, [(3, 4, 1)],directed=False)
    addEdges(G, [(4, 5, 1)],directed=False)
    return G
